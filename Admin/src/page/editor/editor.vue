...
const E = ref({
  ...
  tag: [] as string[],
  coverImg: 'http://yanxuan.nosdn.127.net/77f4c0013dc6ba2ad4330cc06477aae0.jpg',
})
...
<template>
  <div class="box">
    <div>
      <!-- 文章标题 -->
      <div class="title">
        <input v-model="E.title" placeholder="标题(30字以内)" maxlength="30" type="text" />
        <div>
    ...
    <div class="cover">
      ...
      <div class="imgUpload">
        <img @click="E.coverImg = ''" loading="lazy" decoding="async" v-if="E.coverImg" :src="E.coverImg" />
        <template v-else>
          <el-icon class="Plus">
            <Plus />
          </el-icon>
          <ChooseFile @result="coverFile" fileType="image/" accept="image/*" class="ChooseFile"></ChooseFile>
        </template>
      </div>
      <textarea class="imgUrl" v-model="E.coverImg" type="text" placeholder="https://example.com/a.png" />
    </div>
  </div>
</template>
